...
const project = {
  ...
  "githubUrl": "https://github.com/Justin21523/starforge-AI-narrative",
  "readmeUrl": "https://github.com/Justin21523/starforge-AI-narrative#readme",
  ...
  "features": [
    "Detected technical signals: Python, FastAPI, Pydantic, SQLAlchemy, OpenAI API, Transformers, PyTorch, TypeScript, Vite, Docker, pytest, SQLite,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
    "A swappable LLM provider abstraction (mock/OpenAI/local transformers) drives a multi-agent orchestration: a PlannerAgent uses the LLM to plan a tool sequence, a DialogueAgent assembles context, and Memory/Safety agents guard state and content",
    "RAG vector retrieval ingests player-customizable world lore and character settings to generate context-appropriate dialogue and quest outcomes"
  ],
  "metrics": [
    {
      "label": "Demo Modules",
  ...
  "records": [
    {
      "id": "flow-01",
      "name": "Detected technical signals: Python, FastAPI, Pydantic, SQLAlchemy, OpenAI API, Transformers, PyTorch, TypeScript, Vite, Docker, pytest, SQLite,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
      "status": "Ready",
      "owner": "Frontend"
    },
    {
      "id": "flow-02",
      "name": "A swappable LLM provider abstraction (mock/OpenAI/local transformers) drives a multi-agent orchestration: a PlannerAgent uses the LLM to plan a tool sequence, a DialogueAgent assembles context, and Memory/Safety agents guard state and content",
      "status": "Review",
      "owner": "Data"
    },
    {
      "id": "flow-03",
      "name": "RAG vector retrieval ingests player-customizable world lore and character settings to generate context-appropriate dialogue and quest outcomes",
      "status": "Queued",
      "owner": "Automation"
    }
  ]
